      ...
      <div className="p-4 pb-24 space-y-4">
        ...
        <Card className="p-6 border border-gray-200">
          <div className="text-center">
            <div
              className={`mx-auto w-64 h-64 rounded-2xl flex items-center justify-center mb-4 relative overflow-hidden ${
                isScanning
                  ? 'bg-black'
        ...
        <Card className="p-4 border border-gray-200">
          ...
          <div className="space-y-3">
            <Input
              ...
              maxLength={6}
            />
            <p className="text-xs text-gray-500 text-center">Example: AB12CD</p>
            <Button
