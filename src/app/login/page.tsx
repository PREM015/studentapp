...
export default function LoginPage() {
  ...
  useEffect(() => {
    // Wait until NextAuth finishes loading the session
    ...
    if (session?.user) {
      ...
      if (roles.includes("admin")) router.push("/university");
      else if (roles.includes("university")) router.push("/university");
      else if (roles.includes("teacher")) router.push("/teacher");
      else if (roles.includes("student")) router.push("/student");
      else if (roles.includes("club")) router.push("/club");
      else if (roles.includes("tpo")) router.push("/tpo");
